...
if(function_exists('pll_default_language')){
    function custom_acf_settings_default_language($language)
    {
        return pll_default_language("slug");
    }
    function custom_acf_settings_current_language($language)
    {
        return pll_current_language("slug");
    }
    add_filter('acf/settings/default_language', 'custom_acf_settings_default_language');
    add_filter('acf/settings/current_language', 'custom_acf_settings_current_language');
}
...
/* Populate product category into ACF field */

function acf_populate_product_categories($field)
{
    $terms = get_terms([
...
add_filter('acf/load_field/name=settings_template_cat', 'acf_populate_product_categories');
