...
<section class="c-filter bg-white text-primary py-4 py-lg-5">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-10">
                <div class="text-center">
                    <h1><?= the_title(); ?></h1>
                    <div class="c-filter__options py-3">
                        <?= do_shortcode('[searchandfilter id="2660"]'); ?>
                    </div>
                </div>
            </div>
        </div>
...
<section class="c-works-overview mb-4">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div id="product-overview" class="row justify-content-xl-center">
